...
static void test_number()
{
    ...
    TEST_PARSE_NUMBER(-0.239874 / 0.123, "(-0.239874/0.123)");
    TEST_PARSE_NUMBER(23*-0.2/0.123, "(23*(-0.2/0.123))");
    TEST_PARSE_NUMBER(2.34e-46, "2.34e-46");
...
void test_calculate_error()
{
    ...
    TEST_CALCULAT_ERROR(MATH_TOO_LESS_OPERAND, "2*-23.43290+3");
    TEST_CALCULAT_ERROR(MATH_TOO_LESS_OPERAND, "(/)");
    TEST_CALCULAT_ERROR(MATH_TOO_LESS_OPERAND, "(*)");
    TEST_CALCULAT_ERROR(MATH_TOO_LESS_OPERAND, "(-)");
    TEST_CALCULAT_ERROR(MATH_TOO_LESS_OPERAND, "(+)");
}
...
void test_error()
{
    ...
    TEST_ERROR(MATH_NUMBER_TOO_LARGE, "-1e309");
    TEST_ERROR(MATH_INVALID_NUMBER, "()");
    TEST_ERROR(MATH_INVALID_NUMBER, "( )");
    TEST_ERROR(MATH_INVALID_NUMBER, "2(/)");
    TEST_ERROR(MATH_NUMBER_TOO_LARGE, "1e309");
    TEST_ERROR(MATH_NUMBER_TOO_LARGE, "-1e309");
}
